...
def display_results_window(resultsTable):
    ...
    for index, obj in enumerate(resultsTable):
        e = Entry(myframe, relief=RIDGE, fg="green", bd="5", bg="green")
...
sqlquery = Label(root,
                 text="Enter SQL query or type 'q' to quit ! And press enter key to execute. You may also select a table to display its contents.",
...
viewtOptions = OptionMenu(root, viewSelected, "COURSE", "COURSEOFFERING", "STUDCOURSE", "STUDENT", "STUDENTHISTORY",
